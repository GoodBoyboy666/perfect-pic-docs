...
const config: Config = {
  ...
  url: 'https://perfect-pic.goodboyboy.top',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/GoodBoyboy666/perfect-pic-docs/tree/main/packages/create-docusaurus/templates/shared/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Perfect Pic, Built with Docusaurus.`,
    },
    prism: {
